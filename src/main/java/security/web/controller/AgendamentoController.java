...
public class AgendamentoController {
	...
	// abre pagina de agendamento de consultas
	...
	// buscar horarios livres, ou seja, sem agendamentos
	@PreAuthorize("hasAnyAuthority('PACIENTE', 'MEDICO')")
